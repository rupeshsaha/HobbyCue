  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundColor: "#f7fdff", justifyContent: "center", display: "flex", padding: "10px" }}
      >
        <div className="container border rounded-2 m-3 pb-3 pt-3 px-4 py-4" style={{backgroundColor: "white"}}>
          <div className=" d-flex gap-2 align-items-center">
      ...
      <section
        ...
        style={{ backgroundColor: "#F7F5F9", padding: "10px", borderRadius: "6px" }}
      >
      ...
      <div
        className="container-fluid"
        style={{ backgroundColor: "#f7fdff", padding: "15px 30px" }}
      >
        <div>
